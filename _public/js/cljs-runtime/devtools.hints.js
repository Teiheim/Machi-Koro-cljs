...
var file = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27789__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27789__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27789__$1,new cljs.core.Keyword(null,"column","column",2078222095));
...
var temp__5733__auto___27826 = devtools.hints.get_processed_errors_BANG_();
if(cljs.core.truth_(temp__5733__auto___27826)){
var seen_errors_27827 = temp__5733__auto___27826;
if(cljs.core.truth_(seen_errors_27827.has(self))){
} else {
seen_errors_27827.add(self);

var temp__5735__auto___27828 = devtools.hints.error_object_sense(self);
if(cljs.core.truth_(temp__5735__auto___27828)){
var sense_27829 = temp__5735__auto___27828;
(self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),", a sanity hint:\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_27829)].join(''));
} else {
}
}
} else {
