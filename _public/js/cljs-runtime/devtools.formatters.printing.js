...
var len__4736__auto___30309 = arguments.length;
var i__4737__auto___30310 = (0);
while(true){
if((i__4737__auto___30310 < len__4736__auto___30309)){
args__4742__auto__.push((arguments[i__4737__auto___30310]));

var G__30312 = (i__4737__auto___30310 + (1));
i__4737__auto___30310 = G__30312;
continue;
} else {
}
break;
...
/** @this {Function} */
(devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq30183){
...
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__30184,G__30185,seq30183__$2);
}));
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_(new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__30246_SHARP_){
return (!((cljs.core.meta(p1__30246_SHARP_) == null)));
})))){
...
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__30258__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e30268){var _e__27662__auto__ = e30268;
return false;
}})();
if(cljs.core.truth_(or__4126__auto__)){
return or__4126__auto__;
...
}catch (e30270){var _e__27662__auto__ = e30270;
return false;
}}
})())){
...
var _STAR_current_state_STAR__orig_val__30280 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__30281 = devtools.formatters.state.get_current_state();
(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__30281);

try{var map__30282 = opts;
...
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__30282__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__30280);
}});
...
var temp__5733__auto___30339 = devtools.formatters.state.get_managed_print_level();
if(cljs.core.truth_(temp__5733__auto___30339)){
var managed_print_level_30341 = temp__5733__auto___30339;
var _STAR_print_level_STAR__orig_val__30299_30342 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__30300_30343 = managed_print_level_30341;
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__30300_30343);

try{devtools.formatters.state.update_current_state_BANG_((function (p1__30295_SHARP_){
return devtools.formatters.state.set_managed_print_level(p1__30295_SHARP_,null);
}));

job_fn();
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__30299_30342);
}} else {
job_fn();
}
