...
var o29705 = temp__5733__auto__;
var temp__5733__auto____$1 = (o29705["core"]);
if(cljs.core.truth_(temp__5733__auto____$1)){
var o29706 = temp__5733__auto____$1;
return (o29706["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__27655__auto__ = f;
return (o__27655__auto__["toString"]).call(o__27655__auto__);
} else {
return "";
}
}catch (e29708){var _ = e29708;
return "";
}});
...
try{var o__27655__auto___29920 = t;
(o__27655__auto___29920["cljs$lang$ctorPrWriter"]).call(o__27655__auto___29920,t,writer);
}catch (e29712){var __29921 = e29712;
}
...
var char_code = (function (){var o__27655__auto__ = (new String(char$));
return (o__27655__auto__["charCodeAt"]).call(o__27655__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__27655__auto__ = String;
return (o__27655__auto__["fromCharCode"]).call(o__27655__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__29720 = num_code;
switch (G__29720) {
case (1):
return (185);
...
var o__27655__auto__ = String;
return (o__27655__auto__["fromCharCode"]).call(o__27655__auto__,superscript_code);
});
/**
...
}catch (e29722){var _e__27662__auto__ = e29722;
return false;
}})())){
...
var vec__29724 = devtools.munging.parse_fn_source(fn_source);
var name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29724,(0),null);
...
if(cljs.core.truth_(temp__5733__auto__)){
var o29730 = temp__5733__auto__;
var temp__5733__auto____$1 = (o29730["dependencies_"]);
if(cljs.core.truth_(temp__5733__auto____$1)){
var o29731 = temp__5733__auto____$1;
return (o29731["nameToPath"]);
} else {
return null;
}
} else {
...
(devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__29734){
var vec__29735 = p__29734;
var ns_detector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29735,(0),null);
...
var G__29947 = cljs.core.concat.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last(remaining_tokens)], null),name_tokens);
var G__29948 = cljs.core.butlast(remaining_tokens);
name_tokens = G__29947;
remaining_tokens = G__29948;
continue;
}
}
break;
...
/** @this {Function} */
(devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq29732){
var G__29733 = cljs.core.first(seq29732);
var seq29732__$1 = cljs.core.next(seq29732);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__29733,seq29732__$1);
}));
...
var vec__29740 = cljs.core.split_with((function (p1__29739_SHARP_){
return cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(p1__29739_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29740,(0),null);
var arity_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29740,(1),null);
...
var vec__29746 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(remaining_tokens,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([detector], 0));
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29746,(0),null);
var name_and_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29746,(1),null);
if(cljs.core.empty_QMARK_(protocol_ns)){
var G__29950 = cljs.core.rest(remaining_tokens);
var G__29951 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(name_tokens,cljs.core.first(remaining_tokens));
remaining_tokens = G__29950;
name_tokens = G__29951;
continue;
} else {
...
var vec__29752 = devtools.munging.strip_arity(tokens);
var tokens__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29752,(0),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29752,(1),null);
var vec__29755 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(tokens__$1,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([effective_detector], 0));
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29755,(0),null);
var tokens__$2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29755,(1),null);
var vec__29758 = devtools.munging.parse_protocol(tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29758,(0),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29758,(1),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29758,(2),null);
var protocol_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29758,(3),null);
...
var vec__29763 = result;
var munged_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29763,(0),null);
var munged_name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29763,(1),null);
var munged_protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29763,(2),null);
var munged_protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29763,(3),null);
var munged_protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29763,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29763,(5),null);
...
if(cljs.core.truth_(temp__5733__auto__)){
var vec__29778 = temp__5733__auto__;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29778,(0),null);
var args = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29778,(1),null);
var vec__29781 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$1(munged_name);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29781,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29781,(1),null);
...
return cljs.core.concat.cljs$core$IFn$_invoke$arity$2(cljs.core.take.cljs$core$IFn$_invoke$arity$2((2),fn_info),cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),(function (){var G__29784 = cljs.core.second(cljs.core.first(arities));
return (devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1 ? devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1(G__29784) : devtools.munging.parse_fn_info_deep.call(null,G__29784));
})()));
}
} else {
return fn_info;
...
var G__29975 = (arity + (1));
var G__29976 = (function (){var temp__5733__auto__ = devtools.munging.get_fn_fixed_arity(f,arity);
if(cljs.core.truth_(temp__5733__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__29788){
var vec__29789 = p__29788;
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29789,(0),null);
var arity_fn = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29789,(1),null);
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__29813_SHARP_){
return cljs.core.get.cljs$core$IFn$_invoke$arity$2(arities,p1__29813_SHARP_);
}),sorted_keys);
var sorted_infos = cljs.core.map.cljs$core$IFn$_invoke$arity$2(devtools.munging.parse_fn_info_deep,sorted_fns);
var sorted_args_lists = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__29817_SHARP_){
return cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),p1__29817_SHARP_);
}),sorted_infos);
...
(devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__29822){
var vec__29823 = p__29822;
var humanize_QMARK_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29823,(0),null);
...
/** @this {Function} */
(devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq29820){
var G__29821 = cljs.core.first(seq29820);
var seq29820__$1 = cljs.core.next(seq29820);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__29821,seq29820__$1);
}));
...
var include_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__29842__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__29842__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__29842__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__29842__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__29843 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$2(munged_name,ns_detector);
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29843,(0),null);
var fn_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29843,(1),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29843,(2),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29843,(3),null);
var protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29843,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29843,(5),null);
...
var o__27655__auto__ = f;
return (o__27655__auto__["getBasis"]).call(o__27655__auto__);
});
/**
...
}catch (e29855){var _e__27662__auto__ = e29855;
...
var G__29991 = (obj[cljs.core.first(path)]);
var G__29992 = cljs.core.rest(path);
obj = G__29991;
path = G__29992;
continue;
} else {
...
var _STAR_ = (function (accum,p__29869){
var vec__29870 = p__29869;
var bit = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29870,(0),null);
var protocol = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29870,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__29875){
var vec__29876 = p__29875;
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29876,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29876,(1),null);
var selector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29876,(2),null);
...
var post_process = (function (p__29887){
var vec__29890 = p__29887;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29890,(0),null);
var matches__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29890,(1),null);
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__29880_SHARP_){
return (obj[cljs.core.first(p1__29880_SHARP_)]);
}),sorted_matches);
