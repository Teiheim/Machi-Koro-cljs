...
var _STAR_print_newline_STAR__orig_val__29529_29593 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__29530_29594 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__29531_29595 = true;
var _STAR_print_fn_STAR__temp_val__29532_29596 = (function (x__4668__auto__){
return sb__4667__auto__.append(x__4668__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__29531_29595);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__29532_29596);

try{var _STAR_print_level_STAR__orig_val__29533_29597 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__29534_29598 = (300);
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__29534_29598);

try{cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.pprint.pprint,args);
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__29533_29597);
}}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__29530_29594);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__29529_29593);
}
...
/** @this {Function} */
(devtools.util.pprint_str.cljs$lang$applyTo = (function (seq29528){
var self__4724__auto__ = this;
return self__4724__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq29528));
}));
...
var new_formatters = current_formatters.filter((function (p1__29545_SHARP_){
return (!(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(detector,p1__29545_SHARP_)));
}));
...
var G__29546_29611 = f;
var target__27660__auto___29612 = G__29546_29611;
if(cljs.core.truth_(target__27660__auto___29612)){
} else {
throw (new Error(["Assert failed: ",["unable to locate object path ",null," in ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__29546_29611)].join(''),"\n","target__27660__auto__"].join('')));
}

(target__27660__auto___29612["toString"] = (function (){
...
var G__29549_29616 = "%c%s";
var G__29550_29617 = "color:transparent";
var G__29551_29618 = devtools.util.make_detection_printer();
(f.cljs$core$IFn$_invoke$arity$3 ? f.cljs$core$IFn$_invoke$arity$3(G__29549_29616,G__29550_29617,G__29551_29618) : f.call(null,G__29549_29616,G__29550_29617,G__29551_29618));
...
var vec__29561 = devtools.util.feature_list_display(installed_features,feature_groups);
var fmt_str = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29561,(0),null);
var fmt_params = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29561,(1),null);
return devtools.util.wrap_with_custom_formatter_detection_BANG_((function() { 
var G__29622__delegate = function (add_fmt,add_args){
...
var G__29622 = function (add_fmt,var_args){
var add_args = null;
...
while (G__29623__i < G__29623__a.length) {G__29623__a[G__29623__i] = arguments[G__29623__i + 1]; ++G__29623__i;}
  add_args = new cljs.core.IndexedSeq(G__29623__a,0,null);
} 
return G__29622__delegate.call(this,add_fmt,add_args);};
G__29622.cljs$lang$maxFixedArity = 1;
G__29622.cljs$lang$applyTo = (function (arglist__29624){
var add_fmt = cljs.core.first(arglist__29624);
var add_args = cljs.core.rest(arglist__29624);
return G__29622__delegate(add_fmt,add_args);
});
...
/** @this {Function} */
(devtools.util.display_banner_BANG_.cljs$lang$applyTo = (function (seq29556){
...
var G__29559 = cljs.core.first(seq29556__$2);
var seq29556__$3 = cljs.core.next(seq29556__$2);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__29557,G__29558,G__29559,seq29556__$3);
}));
...
var seq__29564 = cljs.core.seq(features);
var chunk__29565 = null;
var count__29566 = (0);
var i__29567 = (0);
while(true){
if((i__29567 < count__29566)){
var feature = chunk__29565.cljs$core$IIndexed$_nth$arity$2(null,i__29567);
...
var G__29625 = seq__29564;
var G__29626 = chunk__29565;
var G__29627 = count__29566;
var G__29628 = (i__29567 + (1));
seq__29564 = G__29625;
chunk__29565 = G__29626;
count__29566 = G__29627;
i__29567 = G__29628;
continue;
} else {
var temp__5735__auto__ = cljs.core.seq(seq__29564);
if(temp__5735__auto__){
var seq__29564__$1 = temp__5735__auto__;
if(cljs.core.chunked_seq_QMARK_(seq__29564__$1)){
var c__4556__auto__ = cljs.core.chunk_first(seq__29564__$1);
var G__29629 = cljs.core.chunk_rest(seq__29564__$1);
var G__29630 = c__4556__auto__;
var G__29631 = cljs.core.count(c__4556__auto__);
var G__29632 = (0);
seq__29564 = G__29629;
chunk__29565 = G__29630;
count__29566 = G__29631;
i__29567 = G__29632;
continue;
} else {
var feature = cljs.core.first(seq__29564__$1);
if(cljs.core.not(cljs.core.some(cljs.core.PersistentHashSet.createAsIfByAssoc([feature]),known_features))){
devtools.context.get_console.call(null).warn(devtools.util.unknown_feature_msg.call(null,feature,known_features,lib_info));
} else {
}
...
var G__29633 = cljs.core.next(seq__29564__$1);
var G__29634 = null;
var G__29635 = (0);
var G__29636 = (0);
seq__29564 = G__29633;
chunk__29565 = G__29634;
count__29566 = G__29635;
i__29567 = G__29636;
continue;
}
} else {
...
if(cljs.core.truth_(temp__5733__auto__)){
var o29584 = temp__5733__auto__;
return (o29584["version"]);
} else {
return null;
}
})() == null);
